...
def define():
    ...
    flags.DEFINE_string('train_log_dir', '/home/docker/apollo/datasets/ocr_sign_posts/weights/current_weights/',
                        'Directory where to write event logs.')

    flags.DEFINE_string('dataset_name', 'fake_dataset',
                        'Name of the dataset. Supported: fake_dataset')
    ...
    flags.DEFINE_string('config_json', '', '')
