...
class BackgroundGenerator:
    ...
    def __init__(self, backgrounds_base_path, yellow_backgrounds_base_path):
        self.backgrounds = self.__get_backgrounds(backgrounds_base_path)
        self.yellow_backgrounds = self.__get_backgrounds(yellow_backgrounds_base_path)
    ...
    def get_random_background(self, is_yellow, width, height):
        bg = random.choice(self.yellow_backgrounds) if is_yellow else random.choice(self.backgrounds)
