...
from ocr.scripts.folder_ocr_predictor import FolderOCRPredictor
...
class OCRPerformanceTest(unittest.TestCase):
    ...
    def test_performance(self):
        ...
        predictor = FolderOCRPredictor("fake_dataset", full_ckpt_path, spell_checker_resources_path = None)

        pred_df_list = [predictor.predict_on_folder(folder, with_gt= True, min_component_size = 25) for folder in predict_folders]
