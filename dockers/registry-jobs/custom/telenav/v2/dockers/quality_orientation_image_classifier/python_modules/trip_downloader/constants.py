...
FACING = 'facing'
DISTANCE = 'distance'
ROI_LONGITUDE = 'detection_longitude'
ROI_LATITUDE = 'detection_latitude'
...
IMAGE_FIELDS = [SEQUENCE_ID, IMAGE_INDEX, LONGITUDE, LATITUDE, IMAGE_WIDTH, IMAGE_HEIGHT, HEADING, OSC_ID, GPS_ACC,
                REGION, FILE_PATH, SHOT_DATE]
