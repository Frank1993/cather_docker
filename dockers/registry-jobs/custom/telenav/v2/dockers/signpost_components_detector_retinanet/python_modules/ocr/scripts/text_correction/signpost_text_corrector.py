...
from ocr.scripts.text_correction.signpost_spell_checker import SignpostSpellChecker


class SignpostTextCorrector(AbstractTextCorrector):

    def __init__(self, spell_checker_resources_path):
        self.spell_checker = None if spell_checker_resources_path is None else SignpostSpellChecker(
