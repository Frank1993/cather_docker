...
class PositionCalculator:
    ...
    def calculate_sign_position(self, obj_bbox, obj_real_dim, angle_of_roi):
        ...
        horizontal_sensor_offset_mm = horizontal_distance_to_obj_px * self.phone_lens.pixel_width
        vertical_sensor_offset_mm = vertical_distance_to_obj_px * self.phone_lens.pixel_height
