...
class OCR_MQ_Predictor(MultiThreadedPredictor):
    ...
    def __init__(self, config, **kwargs):
        ...
        self.ocr_predictor = OCRPredictor(config_api.get_config_param(OCR_MQ_Param.DATASET_CONFIG_KEY, config, ""),
                                          config_api.get_config_param(OCR_MQ_Param.CKPT_PATH_CONFIG_KEY, config, ""),
                                          config_api.get_config_param(OCR_MQ_Param.SPELL_CHECKER_PATH_CONFIG_KEY,
                                                                      config, None))
