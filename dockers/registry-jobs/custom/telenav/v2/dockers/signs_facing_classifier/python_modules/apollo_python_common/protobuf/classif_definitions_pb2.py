...
_CLASSIFPREDICTION = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='chosen_pred_class_name', full_name='orbb.ClassifPrediction.chosen_pred_class_name', index=3,
