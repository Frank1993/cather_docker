...
DEFAULT_DATASET_DIR = "/home/docker/apollo/datasets/ocr_traffic_signs/fake_generated/1mil_v6/tf_data"

# The dataset configuration, should be used only as a default value.
DEFAULT_CONFIG = {
    'name': 'Fake Dataset TS',
    'splits': {
        'train': {
            'size': 1000000,
            'pattern': 'train/train*'
...
def get_split(split_name, dataset_dir=None, config=None):
  ...
  """
    ...
    return slim.dataset.Dataset(
        ...
        items_to_descriptions={},  # initially passed from config. seems like not needed
