...
class HazardAggregator:
    ...
    def __are_clusters_close_enough(self, gps_distance, time_distance):
    ...
    def compute_matching(self, gt_centroid_df, pred_centroid_df):
        ...
        for _, gt_row in gt_centroid_df.iterrows():
            ...
            for _, pred_row in self.__filter_out_matched_preds(pred_centroid_df, matched_pred_ids).iterrows():
                ...
                gps_distance, time_distance = self.__compute_distances_between_clusters(gt_row, pred_row)
                if self.__are_clusters_close_enough(gps_distance, time_distance):
        ...
        fp_list = self.__filter_out_matched_preds(pred_centroid_df, matched_pred_ids)[Column.CLUSTER_ID].values
    ...
    def __select_best_thresholds(self, trip_test_df, eps_list, min_samples_list, metric='f1'):
    ...
    def get_best_clustering_params(self, trip_test_df):
        ...
        eps, min_samples = self.__select_best_thresholds(trip_test_df, eps_list, min_samples_list, metric='f1')
