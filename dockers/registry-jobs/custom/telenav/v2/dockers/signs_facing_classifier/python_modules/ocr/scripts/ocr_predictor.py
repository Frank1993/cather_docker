...
from ocr.scripts.text_corrector import TextCorrector
...
class OCRPredictor:
    ...
    def __init__(self, dataset_name, ckpt_path, spell_checker_resources_path):
        ...
        self.text_corrector = TextCorrector(spell_checker_resources_path)

        self.imgs_placeholder, self.endpoints = self.__get_model()
    ...
    def __load_model(self):
        dataset = common_flags.create_dataset(split_name="train")
