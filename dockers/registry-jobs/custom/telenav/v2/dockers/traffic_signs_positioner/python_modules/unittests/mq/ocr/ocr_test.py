...
from ocr.scripts.mq_ocr_predictor import OCR_MQ_Predictor
from unittests.mq.components.accumulation_consumer import AccumulationConsumer

from unittests.mq.ocr.custom_mq_provider import CustomMQProvider
...
class OCRTest(unittest.TestCase):
    ...
    def get_provider(self, output_queue, gt_rois_file):
        ...
        return CustomMQProvider(conf, gt_rois_file)
